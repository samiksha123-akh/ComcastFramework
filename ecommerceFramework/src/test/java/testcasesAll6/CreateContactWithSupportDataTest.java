...
// accessing test data from excel...
        ...
        String lstname=sh.getRow(4).getCell(2).getStringCellValue();
...
// capture current date and modified date
    LocalDate currentdate= LocalDate.now(); 
    LocalDate modifieddate=currentdate.plusDays(30); 
...
// enter mandatory fields...and create contact
         ...
         driver.findElement(By.name("support_start_date")).sendKeys(currentdate.toString());
         
         driver.findElement(By.name("support_end_date")).clear();
         driver.findElement(By.name("support_end_date")).sendKeys(modifieddate.toString());
...
//verify the header msj expected result
         Thread.sleep(2500);
          ...
          String text=driver.findElement(By.id("dtlview"))")).getText();
